        ...
        <nav class="bg-white shadow-lg fadeInTop">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					...
					<li><a href="contact.php" class="block text-sm px-2 py-4 hover:bg-blue-600 transition duration-300 text-base font-regular">Contact Us</a></li>
		...
		<div class="flex pt-5 md:pt-12 justify-center">
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="md:w-1/2 h-64 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:rounded-bl-lg md:h-auto overflow-hidden">
					<img id="dish-page-image" class="object-cover" src="../assets/images/default-profile.jpeg" />
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					<h2 id="dish-page-name" class="text-3xl font-medium text-blue-600">Butter Chicken</h2>
					...
					<p id="dish-page-ingredients" class="mt-4 text-gray-600 text-base font-regular">
						<!-- <span><li class="text-base font-regular">1/2 cup Boiled Capsicum</li></span>
		...
		<div class="py-5 flex justify-center">
			<div class="bg-white w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					<h2 class="text-2xl font-medium text-blue-600">Directions<span class="text-indigo-600"></span></h2>
					<span class="bg-green-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Instructions</span>
		...
		<form class="w-full bg-white rounded-lg px-4 pt-2">
		   ...
		   <div id="dish-comments" class="w-full px-4 pt-2 pb-2 mt-4">
			   <!-- <div class="flex flex-row w-full p-2">
					...
					<div class="ml-2">
						<h2 class="text-gray-800 text-lg font-medium mb-2 cursor-pointer">Ashutosh Hathidara</h2>
