...
<body class="bg-blue-50">
    ...
    <header>
        <nav class="bg-white shadow-lg fadeInTop">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					<li id="nav-profile-img-mobile"><a href="#about" class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300 text-base font-regular">Profile</a></li>
					<li class="active"><a href="home.html" class="block text-sm px-2 py-4 text-white bg-blue-600 text-base font-regular">Home</a></li>
					<li><a href="#services" class="block text-sm px-2 py-4 hover:bg-blue-600 transition duration-300 text-base font-regular">Contact Us</a></li>
            ...
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form class="p-6 flex flex-col justify-center" action="process.php" method="post">
                        ...
                        <button name="btn-send" type="submit" action="process.php" class="bg-gradient-to-r from-green-400 to-blue-500 hover:from-green-500 hover:to-green-500 ...,md:w-32 bg-indigo-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
    ...
    <span style="float: left;margin-left: 20%;margin-top: -20%;margin-bottom: 100px">
     <div class="card w-96">
  <img class="h-52 object-cover" src="../assets/images/ashutosh.jpeg" alt="Ashutosh" style="width:100%">
  <h1 class="font-medium">Ashutosh Hatidhara</h1>
  <p class="title">Creator</p>
  <p class="font-light">Testimony....</p>
  <div style="margin: 24px 0;">
    <a class = "mx-4 text-blue-600" href="#"><i class="fa fa-github"></i></a>
    <a class = "mx-4 text-blue-600" href="#"><i class="fa fa-twitter"></i></a> 
    <a class = "mx-4 text-blue-600" href="#"><i class="fa fa-linkedin"></i></a>  
    <a class = "mx-4 text-blue-600" href="#"><i class="fa fa-facebook"></i></a> 
  </div>
</div>
</span>
<span style="float: right;margin-right: 20%;margin-top: -20%;margin-bottom: 100px">
	<div class="card w-96">
  <img class="h-52 object-cover" src="../assets/images/lalit.jpeg" alt="Lalit" style="width:100%">
  <h1 class="font-medium">Lalit Pandey</h1>
  <p class="title">Creator</p>
  <p class="font-light">Testimony....</p>
  <div style="margin: 24px 0;">
    <a class = "mx-4 text-blue-600" href="#"><i class="fa fa-github"></i></a>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCbbDngXPNO8TNwAbltitBBpxruNQvQzQ&callback=myMap"></script>
   ...
   <div id="map"></div>
    ...
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCbbDngXPNO8TNwAbltitBBpxruNQvQzQ&callback=initMap&libraries=&v=weekly"
      async
    ></script>
...
function initMap() {
  ...
  const uluru = { lat: 39.166592, lng: -86.534889 };
...
<span class="w-full min-h-screen " x-data="topBtn">
    <button @click="scrolltoTop" id="topButton"
        class="  p-1 bg-blue-600 rounded-full  animate-bounce" style="width: 39px;height: 40px;margin-left: 90%;margin-top: 2%">
...
-->
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
            <div class="px-5 py-2">
                <a href="#" class="text-base leading-6 text-blue-600 hover:text-blue-700">
                    Home
                </a>
            </div>
        ...
        <p class="mt-8 text-base leading-6 text-center text-blue-400">
